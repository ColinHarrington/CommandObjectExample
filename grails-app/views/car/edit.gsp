                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="wheel"><g:message code="car.wheel.label" default="Wheel" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: carInstance, field: 'wheel', 'errors')}">
                                    <g:select name="wheel.id" from="${com.example.Wheel.list()}" optionKey="id" value="${carInstance?.wheel?.id}"  />
                                </td>
                            </tr>
